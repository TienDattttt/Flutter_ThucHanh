          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  "Số sản phẩm : ${orderDetails!.orderItems.length}",
                  style: const TextStyle(
                    fontSize: 14,
                  ),
                ),
                Text(
                  "Giá đơn hàng : ${orderDetails!.orderItems.fold(0.0, (previousValue, element) => (previousValue + (element.price * element.quantity)))}",
                  style: const TextStyle(
                    fontSize: 14,
                  ),
                ),
                Text(
                  "Giảm giá : ${orderDetails!.discount}",
                  style: const TextStyle(
                    fontSize: 14,
                  ),
                ),
